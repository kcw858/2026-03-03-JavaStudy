...
public class 리플렉션_1 {
	...
	public static void main(String[] args) {
		...
		try 
		{
			...
			// 클래스 정보에서 생성자를 가지고 온다
			Constructor con = clsName.getConstructor(); // 디폴트 생성자
			
			// 메모리 할당
			Object obj = con.newInstance();
			
			//메소드 읽기
			Method m = clsName.getMethod("info"); //메소드 정보 읽기
